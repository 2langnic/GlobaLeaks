...
GLClient.controller('ReceiverPreferencesCtrl', ['$scope', '$rootScope','Node','ReceiverPreferences', 'changePasswordWatcher', 'CONSTANTS',
  function($scope, $rootScope,Node, ReceiverPreferences, changePasswordWatcher, CONSTANTS) {
